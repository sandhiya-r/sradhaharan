        ...
        <section className="relative min-h-screen flex items-center overflow-hidden">
            ...
            <div className="container mx-auto px-6 pt-32 pb-20 relative z-10">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="space-y-4">
                            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight animate-fade-in animation-delay-200">
                                Engineering <span className="text-primary glow-text tiny5-regular">solutions</span> that solve real <span className="tiny5-regular text-secondary">problems</span>
                            </h1>
                ...
                <div className="mt-20 animate-fade-in animation-delay-600">
                    <p className="text-sm text-muted-foreground mb-6 text-center">Languages and Frameworks I've Used: </p>
